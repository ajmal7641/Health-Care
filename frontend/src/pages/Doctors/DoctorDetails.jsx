                  ...
                  <div className='md:col-span-2'>
                        ...
                        <div className="flex items-center gap-5">
                              ...
                              <div>
                                    ...
                                    <p className="text_para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
                                          earum quibusdam voluptates rem libero dolor, 
                                          </p>
                              </div>
                        </div>
