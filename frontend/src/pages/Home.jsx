        ...
        <div className="flex items-center justify-between flex-col lg:flex-row ">
          ...
          <div className='xl:w-[670px] '>
            ...
            <ul className="pl-4">
              ...
              <li className="text_para">2.Search your physician here, and conatct their office</li>
          ...
          <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
            ...
            <div className="w-[150px] lg:w-[248px] bg-white absolute bott-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb[26px] rounded-[10px]">
    ...
    <section>
      <div className="container">
        <div className="flex justify-between gap-[50px] lg:gap-0">
          ...
          <h2 className="heading">
            Most questions by our beloved paients
          </h2>
          <FaqList/>
          </div>
        </div>
